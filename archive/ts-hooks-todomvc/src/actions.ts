...
export const create = (text: string): StateTransformer<TodoAppState> => 
    state => state.addItem(new TodoItem(text));
...
export const updateText = (item: TodoItem, text: string): StateTransformer<TodoAppState> => 
    state => state.addItem(item.set('text',text));

export const toggleComplete = (item: TodoItem): StateTransformer<TodoAppState> => 
    state => state.addItem(item.set('complete', !item.complete));
...
export const destroy = (id: string): StateTransformer<TodoAppState> => 
