...
/***/ function(module, exports, __webpack_require__) {
	...
	var item0 = new _todoItem2.default('This is a test item');
	var state0 = new _todoAppState2.default();
	var todoAppState = state0.addItem(item0);
	
	React.render(React.createElement(_TodoApp2.default, { appState: todoAppState }), document.getElementById('todoapp'));
